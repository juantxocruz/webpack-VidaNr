...
let modal_header_info = self.document.getElementById("modal_header_info");
let modal_header_result = self.document.getElementById("modal_header_result");
...
let modal_footer_info = self.document.getElementById("modal_footer_info");
let modal_footer_result = self.document.getElementById("modal_footer_result");
// MODAL WINDOW
...
function drawModalWindowInnerHTML(message) {
    modal_header_info.innerHTML = message.header;
    modal_body1_span.innerHTML = message.action;
    modal_body2_span.innerHTML = message.content;
    modal_footer_info.innerHTML = year + message.footer;
